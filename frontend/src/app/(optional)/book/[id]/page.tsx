                                ...
                                حذف
                                        ...
                                        { 
                                            user.role<3&&(          <div className="items-center  self-center flex flex-col sm:flex-row w-1/2 gap-y-3 sm:gap-y-0 sm:items-center sm:justify-around">
                                                <Link className="p-4 sm:w-1/4 w-1/2 text-md font-black bg-green-400 hover:text-black transition-colors duration-300 rounded-md text-center" href={`/book/mod/edit/${book.id}`}>
                                                تعديل كمشرف
                                                </Link>
